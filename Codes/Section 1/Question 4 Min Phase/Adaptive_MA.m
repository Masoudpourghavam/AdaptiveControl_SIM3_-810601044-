...
for k = 1:N-1
    ...
    r0(k, 1) = ((c_hat1(k, 1) - a_hat1(k, 1)) * b_hat0(k, 1)^2 - (b_hat1(k, 1) * b_hat0(k, 1) * (c_hat0(k, 1) - a_hat0(k, 1)))) / (b_hat0(k, 1)^2 + (b_hat1(k, 1)^2) * a_hat0(k, 1) - (a_hat1(k, 1) * b_hat1(k, 1) * b_hat0(k, 1)));
    s0(k, 1) = -(a_hat0(k, 1) / b_hat0(k, 1)) * r0(k, 1);
    s1(k, 1) = (c_hat0(k, 1) - a_hat0(k, 1) - a_hat1(k, 1) * r0(k, 1) - b_hat1(k, 1) * s0(k, 1)) / b_hat0(k, 1);
